<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentInfo.aspx.cs" Inherits="StudentPortal1._01.Pages.Faculty.StudentInfo" %>
      ...
      <asp:ListView ID="lvcourse" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><td><asp:LinkButton runat="server" CommandName="Details" OnCommand="Marks_Click" CommandArgument='<%# Eval("course_id")%>'>Marks</asp:LinkButton></td></td>
                        </tr>
                    </ItemTemplate>
                    <LayoutTemplate>
