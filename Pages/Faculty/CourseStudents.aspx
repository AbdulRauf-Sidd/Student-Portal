<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CourseStudents.aspx.cs" Inherits="StudentPortal1._01.Pages.Faculty.CourseStudents" %>
            ...
            <asp:ListView ID="lvcourse" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><td><asp:LinkButton runat="server" CommandName="Details" OnCommand="Marks_Click" CommandArgument='<%# Eval("roll_no")%>'>Marks</asp:LinkButton></td></td>
                        </tr>
                    </ItemTemplate>
                    <LayoutTemplate>
