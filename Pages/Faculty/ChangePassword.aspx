<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="StudentPortal1._01.Pages.Faculty.ChangePassword" %>
...
<div class="container">
    <div class="box">
        Current Password: <asp:TextBox ID="current_password" runat="server"></asp:TextBox> <asp:Label ID="label1" runat="server" ForeColor="Red"></asp:Label>
        <br /> <br />
        New Password: <asp:TextBox ID="new_password" runat="server"></asp:TextBox> <asp:Label ID="label2" runat="server" ForeColor="Red"></asp:Label>
        <br /><br />
