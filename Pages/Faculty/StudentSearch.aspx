<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentSearch.aspx.cs" Inherits="StudentPortal1._01.Pages.Faculty.StudentSearch" %>
...
<div class="container">
    ...
    <div class="box">
      <asp:listview ID="students" runat="server">
          <ItemTemplate>
                        <tr>
                            <td><%# Eval("roll_no")%></td>
                            <td style="padding-left:50px"><%# Eval("student_name")%></td>
                            <td style="padding-left:50px"><%# Eval("section")%></td>
                            <td><td><asp:LinkButton runat="server" CommandName="Details" OnCommand="Student_Click" CommandArgument='<%# Eval("roll_no")%>'>Course List</asp:LinkButton></td></td>
                        </tr>
                    </ItemTemplate>
                    <LayoutTemplate>
                        <table id="tbl1" runat="server" cellspacing="5">
                            <tr id="tr1" runat="server">
                                ...
                                <td id="td3" runat="server" style="padding-left:50px">Section</td>
                            </tr>
    ...
    <div class="LL"><strong>Profile</strong>
