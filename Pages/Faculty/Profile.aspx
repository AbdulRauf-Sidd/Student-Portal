<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="StudentPortal1._01.Pages.Faculty.Profile" %>
...
<body>
 ...
 <div class="container">
    <div class="box">
      ...
      <strong>Name: </strong><asp:Label runat="server" ID="faculty_name2"></asp:Label>
      <br><br>
      <strong>Address: </strong><asp:Label runat="server" ID="address"></asp:Label><br><br>
      <strong>Phone: </strong> <asp:Label runat="server" ID="phone"></asp:Label><br><br>
        <asp:button ID="change_password" runat="server" OnClick="Change_Password_Click" Text="Change Password"/>        <asp:Button runat="server" ID="edit" OnClick="Edit_Click" Text="Edit Profile" />
         </div>
