<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentCourse.aspx.cs" Inherits="StudentPortal1._01.Pages.Admin.StudentCourse" %>
...
<body>
 ...
 <div class="container">
            ...
            <asp:ListView ID="lvcourse" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><td><asp:LinkButton runat="server" CommandName="Details" OnCommand="Delete_Click" CommandArgument='<%# Eval("course_id")%>'>Delete</asp:LinkButton></td></td>
                        </tr>
                    </ItemTemplate>
                    <LayoutTemplate>
                        <table id="tbl1" runat="server" cellspacing="5">
                            <tr id="tr1" runat="server">
                                <td id="td1" runat="server">Roll No</td>
    ...
    <div class="header">
     ...
     Add Course: <asp:DropDownList ID="courses" runat="server"></asp:DropDownList> <asp:Button ID="add" runat="server" OnClick="Add_Click" Text="Add" />
     </div>
     </form>
</body>
</html>
