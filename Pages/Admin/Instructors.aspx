<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Instructors.aspx.cs" Inherits="StudentPortal1._01.Pages.Admin.Instructors" %>
    ...
    <div class="box">
        <div id="listviewcourse">
            <asp:ListView ID="lvstudent" runat="server">
                    <ItemTemplate>
                        <tr>
                            <td style="padding-left:50px"><%# Eval("instructor_id")%></td>
                            <td style="padding-left:50px"><%# Eval("instructor_name")%></td>
                            <td style="padding-left:50px"><%# Eval("address")%></td>
                            <td style="padding-left:50px"><%# Eval("phone_no")%></td>
                            <td><td><asp:LinkButton runat="server" CommandName="Details" OnCommand="Details_Click" CommandArgument='<%# Eval("instructor_id")%>'>Details</asp:LinkButton></td></td>
                        </tr>
                    </ItemTemplate>
                    <LayoutTemplate>
                        <table id="tbl1" runat="server" cellspacing="5">
                            <tr id="tr1" runat="server">
                                <th id="td2" runat="server" style="padding-left:50px">ID</th>
                                <th id="td3" runat="server" style="padding-left:50px">Name</th>
                                <th id="td4" runat="server" style="padding-left:50px">Address</th>
                                <th id="td5" runat="server" style="padding-left:50px">Phone No</th>
                            </tr>
