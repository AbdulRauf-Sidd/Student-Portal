<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCourse.aspx.cs" Inherits="StudentPortal1._01.Pages.Admin.AddCourse" %>
...
<body>
 ...
 <div class="container">
    <div class="box">
        Course Name: <asp:TextBox ID="cname" runat="server"></asp:TextBox> <asp:Label ID="cnamelb" runat="server" ForeColor="Red"></asp:Label>
        <br /><br />
        <asp:Label ID="label3" runat="server" ForeColor="Green"></asp:Label>
        <asp:Button ID="save" runat="server" Text="Add Course" OnClick="Add_Click" />
               </div>
