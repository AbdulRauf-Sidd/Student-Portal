<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Students.aspx.cs" Inherits="StudentPortal1._01.Pages.Admin.Students" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <ul>
            ...
            <li> <asp:HyperLink ID="AddInstructorhl" runat="server" NavigateUrl="AddInstructor.aspx" ForeColor="White">Add Instructor</asp:HyperLink></li>        </ul>
    </div>
 <div class="container">
     <div class="query">
         Enter Roll No.
        ...
        <div id="listviewcourse">
            <asp:ListView ID="lvstudent" runat="server">
                    <ItemTemplate>
                        <tr>
                            <td><%# Eval("roll_no")%></td>
                            <td style="padding-left:50px"><%# Eval("student_name")%></td>
                            <td style="padding-left:50px"><%# Eval("department")%></td>
                            <td style="padding-left:50px"><%# Eval("semester")%></td>
                            <td style="padding-left:50px"><%# Eval("section")%></td>
                            <td><td><asp:LinkButton runat="server" CommandName="Details" OnCommand="Details_Click" CommandArgument='<%# Eval("roll_no")%>'>Details</asp:LinkButton></td></td>
                        </tr>
                    </ItemTemplate>
                    <LayoutTemplate>
                        <table id="tbl1" runat="server" cellspacing="5">
                            <tr id="tr1" runat="server">
                                <td id="td1" runat="server">Roll No ID</td>
                                <td id="td2" runat="server" style="padding-left:50px">Student Name</td>
                                <td id="td3" runat="server" style="padding-left:50px">Department</td>
                                <td id="td4" runat="server" style="padding-left:50px">Semester</td>
                                <td id="td5" runat="server" style="padding-left:50px">Section</td>
                            </tr>
