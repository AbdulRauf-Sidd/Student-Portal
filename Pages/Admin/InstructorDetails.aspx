<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InstructorDetails.aspx.cs" Inherits="StudentPortal1._01.Pages.Admin.InstructorDetails" %>
...
<body>
 ...
 <div class="container">
    <div class="box">
        ID: <asp:Label ID="tid2" runat="server"></asp:Label> <asp:Label ID="rolllb" runat="server" ForeColor="Red"></asp:Label>
        <br /> <br />
        ...
        <asp:Label ID="addresslb" runat="server" ForeColor="Red"></asp:Label>
        <br /><br />
        Phone: <asp:TextBox ID="phone" runat="server"></asp:TextBox> <asp:Label ID="pho" runat="server" ForeColor="Red"></asp:Label> 
        <br /><br />
        <asp:Button ID="save" runat="server" OnClick="Save_Click" Text="Save" />
        <asp:Button ID="courses" runat="server" OnClick="Courses_Click" Text="Edit Courses" />
        <asp:Button ID="delete" runat="server" OnClick="Delete_Click" Text="Delete Student" />
