...
{
    public partial class AddInstructorCourse : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                con.Open();
                SqlCommand sqlCommand = new SqlCommand("SELECT sections FROM Course_Instructor WHERE course_id = @course_id", con);
        ...
        protected void Add_Click(object sender, EventArgs e)
        {
            if (secdrop.Text.Length > 0)
            {
                ...
                SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["myConnectionString"].ConnectionString);
                con.Open();
                SqlCommand sqlCommand = new SqlCommand("INSERT INTO Course_Instructor VALUES (@course_id, @id, @sec)", con);
                sqlCommand.Parameters.AddWithValue("course_id", course_id);
