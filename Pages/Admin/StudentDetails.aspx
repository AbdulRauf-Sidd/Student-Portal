<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentDetails.aspx.cs" Inherits="StudentPortal1._01.Pages.Admin.StudentDetails" %>
...
<body>
 ...
 <div class="container">
    <div class="box">
        Roll No: <asp:Label ID="roll_no" runat="server"></asp:Label> <asp:Label ID="rolllb" runat="server" ForeColor="Red"></asp:Label>
        <br /> <br />
