<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InstructorCourses.aspx.cs" Inherits="StudentPortal1._01.Pages.Admin.InstructorCourses" %>
...
<body>
 ...
 <div class="container">
    <div class="box">
            ...
            <asp:ListView ID="lvcourse" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="padding-left:50px"><%# Eval("course_id")%></td>
                            <td style="padding-left:50px"><%# Eval("course_name")%></td>
                            <td><td><asp:LinkButton runat="server" CommandName="Details" OnCommand="Edit_Click" CommandArgument='<%# Eval("course_id")%>'>Edit</asp:LinkButton></td></td>
                            <td><td><asp:LinkButton runat="server" CommandName="Delete" OnCommand="Delete_Click" CommandArgument='<%# Eval("course_id")%>'>Delete</asp:LinkButton></td></td>
                        </tr>
                    </ItemTemplate>
                    <LayoutTemplate>
                        <table id="tbl1" runat="server" cellspacing="5">
                            <tr id="tr1" runat="server">
                                <td id="td1" runat="server">Instructor ID</td>
                                <td id="td2" runat="server" style="padding-left:50px">Course ID</td>
                                <td id="td3" runat="server" style="padding-left:50px">Course Name</td>
                            </tr>
     ...
     <div class="query">
         <asp:DropDownList ID="coursedrop" runat="server"></asp:DropDownList> &nbsp <asp:Button ID="add" runat="server" Text="Add" OnClick="Add_Click"/>
     </div>
