<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="StudentPortal1._01.Pages.Admin.Dashboard" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <ul>
            ...
            <li> <asp:HyperLink ID="Studentshl" runat="server" NavigateUrl="Students.aspx" ForeColor="White">Students</asp:HyperLink></li>
